...
@Component({
  selector: 'app-fingerprint-scan-stage-fail',
  templateUrl: './fingerprint-scan-stage-fail.component.html',
  styleUrls: ['./fingerprint-scan-stage-fail.component.css']
})
export class FingerprintScanStageFailComponent {
