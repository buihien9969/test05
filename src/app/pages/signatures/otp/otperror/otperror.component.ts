...
@Component({
  selector: 'app-otperror',
  templateUrl: './otperror.component.html',
  styleUrls: ['./otperror.component.css']
})
...
// Handle OTP resend
  ...
  appendDigit(digit: string) {
    ...
    // Xử lý trường hợp nhập các số khác
